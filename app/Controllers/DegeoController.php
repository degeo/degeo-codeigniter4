...
class DegeoController extends BaseController
{
	...
	protected function create_default_resources()
	{
		...
		// Queue Application Resources
		$resources->add( 'header', '<link rel="stylesheet" href="' . base_url( 'assets/css/application.css' ) . '"/>', 49 );
		$resources->add( 'header', '<script src="' . base_url( 'assets/js/application.js' ) . '"></script>', 500 );
