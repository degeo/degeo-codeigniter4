	...
	<body>
		...
		<div class="wrap">
			...
			<div class="guide">
				...
				<h2>DeGeo Application Config</h2>
				<pre>
					<code>
				...
				<h2>DeGeo Metatags Queue Library</h2>
				<pre>
					<code>
						<?php echo htmlentities( print_r($metatags, true) ); ?>
					</code>
				</pre>

				<h2>DeGeo Messages Queue Library</h2>
				<pre>
					<code>
				...
				<h2>DeGeo Breadcrumbs Queue Library</h2>
				<pre>
					<code>
			...
			<div class="guide">
				...
				<pre>
				<code>
					app/Views/degeo_welcome_message.php
				</code>
				</pre>
